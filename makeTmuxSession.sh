...
then
    ...
    tmux new-window -n dev -d   'cd ~/enthenergy/etireports/etirweb; workon pyramid; bash -i'
    ...
    tmux new-window -n dbCons -d 'cd ~/enthenergy/etireports/etirweb; bash -i'
    tmux new-window -n ipython -d 'cd ~/enthenergy/etireports/etirweb; workon pyramid; ipython; bash -i'
